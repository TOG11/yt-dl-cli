...
if (!moduleAvailable("uuid"))
childProcess.exec("npm i uuid -g");

if (!moduleAvailable("cli-progress"))
childProcess.exec("npm i cli-progress -g");

if (!moduleAvailable("ansi-colors"))
childProcess.exec("npm i ansi-colors -g");


if (!moduleAvailable("ytdl-core"))
childProcess.exec("npm i ytdl-core -g");

if (!moduleAvailable("request"))
childProcess.exec("npm i request -g");
